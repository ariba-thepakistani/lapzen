      ...
      <section className="relative w-full overflow-hidden min-h-[500px] lg:min-h-[600px] flex items-center pt-0">
        ...
        <div className="container relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24 py-8 md:py-12">
            ...
            <div className="w-full md:w-[40%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left order-1 md:order-2">
              <h1 className="text-[48px] sm:text-[64px] lg:text-[80px] font-black text-foreground uppercase tracking-tighter leading-[0.9] mb-10">
                CARRY THE <br /> FUTURE
              </h1>
