            ...
            <div className="lg:col-span-1">
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 sticky top-32">
                ...
                <div className="mt-6 flex items-center justify-center gap-4">
                  <Image src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/3703ae26-4d55-4c16-ad94-b7374ad76a02-lapzen-store/assets/svgs/visa.svg" alt="Visa" width={40} height={25} className="opacity-60 grayscale hover:grayscale-0 transition-all" />
                  <Image src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/3703ae26-4d55-4c16-ad94-b7374ad76a02-lapzen-store/assets/svgs/mastercard.svg" alt="Mastercard" width={40} height={25} className="opacity-60 grayscale hover:grayscale-0 transition-all" />
